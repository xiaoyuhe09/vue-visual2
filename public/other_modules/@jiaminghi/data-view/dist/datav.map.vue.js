(function (global, factory) {
  ...
  var util$1 = createCommonjsModule(function (module, exports) {
    ...
    function deepMerge(target, merged) {
      for (var key in merged) {
        target[key] =
          target[key] && (0, _typeof2["default"])(target[key]) === "object"
  ...
  var __vue_render__$6 = function () {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("div", { ref: _vm.ref, staticClass: "dv-border-box-1" }, [
      _c(
        "svg",
        {
          ...
          [
            _c("animate", {
              attrs: {
                ...
                attributeType: "XML",
                from:
                  "0, " + _vm.line1Length / 2 + ", 0, " + _vm.line1Length / 2,
          ...
          [
            _c("animate", {
              attrs: {
                ...
                attributeType: "XML",
                from:
                  "0, " + _vm.line2Length / 2 + ", 0, " + _vm.line2Length / 2,
          ...
          [
            _c("animate", {
              attrs: {
                ...
                attributeName: "stroke-dasharray",
                values:
                  "0, " + _vm.width * 0.2 + ";" + _vm.width * 0.2 + ", 0;",
                dur: "3s",
  ...
  var bezierCurveToPolyline_1 = createCommonjsModule(function (
    module,
    exports
  ) {
    Object.defineProperty(exports, "__esModule", {
  ...
  var polylineToBezierCurve_1 = createCommonjsModule(function (
    module,
    exports
  ) {
    Object.defineProperty(exports, "__esModule", {
  ...
  var graphs_1 = createCommonjsModule(function (module, exports) {
    ...
    var ellipse = {
      ...
      hoverCheck: function hoverCheck(position, _ref11) {
        ...
        var distance =
          (0, util.getTwoPointDistance)(position, leftFocusPoint) +
          (0, util.getTwoPointDistance)(position, rightFocusPoint);
        return distance <= 2 * a;
      },
    ...
    var sector = {
      ...
      hoverCheck: function hoverCheck(position, _ref39) {
        ...
        var rx = shape.rx,
          ...
          endAngle = shape.endAngle,
          clockWise = shape.clockWise;
        return (0, util.checkPointIsInSector)(
          position,
          rx,
          ry,
          r,
    ...
    var polyline = {
      ...
      hoverCheck: function hoverCheck(position, _ref55) {
        ...
        if (close) {
          ...
          return (0, util.checkPointIsNearPolyline)(
            position,
            points,
            lineWidth
          );
  ...
  var graph_class = createCommonjsModule(function (module, exports) {
    ...
    Graph.prototype.hoverCheckProcessor = function (position, _ref) {
      ...
      if (graphCenter) {
        if (rotate)
          position = (0, util.getRotatePointPos)(
            -rotate,
            position,
            graphCenter
          );
        if (scale)
          position = (0, util.getScalePointPos)(
        ...
        if (translate)
          position = (0, util.getTranslatePointPos)(
      ...
      if (hoverRect)
        return util.checkPointIsInRect.apply(
          void 0,
  ...
  var pie = {
    ...
    draw: function draw(_ref2, _ref3) {
      ...
      var connectPoint1 = (0, util.getCircleRadianPoint)(
        rx,
        ry,
        or,
        endAngle
      ...
      var connectPoint2 = (0, util.getCircleRadianPoint)(
        rx,
        ry,
        ir,
        startAngle
  ...
  var agArc = {
    ...
    draw: function draw(_ref5, _ref6) {
      ...
      for (var i = 0; i < gradientArcNum; i++) {
        ctx.beginPath();
        var startPoint = (0, util.getCircleRadianPoint)(
          rx,
          ry,
          r,
          startAngle + angleGap * i
        );
        var endPoint = (0, util.getCircleRadianPoint)(
          rx,
          ry,
          r,
          startAngle + angleGap * (i + 1)
        );
        var color = (0, util$1.getLinearGradientColor)(
          ctx,
          startPoint,
          endPoint,
  ...
  var numberText = {
    ...
    draw: function draw(_ref8, _ref9) {
      ...
      ctx.strokeText.apply(
        ctx,
        [textString].concat((0, _toConsumableArray2["default"])(position))
      );
      ctx.fillText.apply(
        ctx,
        [textString].concat((0, _toConsumableArray2["default"])(position))
  ...
  var title_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function title(chart) {
      ...
      if (option.title) {
        title[0] = (0, util$1.deepMerge)(
          (0, util.deepClone)(config.titleConfig, true),
          option.title
        );
      }
  ...
  var grid_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function grid(chart) {
      ...
      grid = (0, util$1.deepMerge)(
        (0, util.deepClone)(config.gridConfig, true),
        grid || {}
      );
      (0, updater_class.doUpdate)({
        chart: chart,
  ...
  var axis_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function mergeDefaultAxisConfig(allAxis) {
      ...
      xAxis = xAxis.map(function (axis) {
        return (0,
        util$1.deepMerge)((0, util.deepClone)(config.xAxisConfig), axis);
      });
      yAxis = yAxis.map(function (axis) {
        return (0,
        util$1.deepMerge)((0, util.deepClone)(config.yAxisConfig), axis);
      });
      return [].concat(
        (0, _toConsumableArray2["default"])(xAxis),
        (0, _toConsumableArray2["default"])(yAxis)
    ...
    function setAxisPosition(allAxis) {
      ...
      if (xAxis[0] && !xAxis[0].position)
        xAxis[0].position = config.xAxisConfig.position;
      ...
      if (yAxis[0] && !yAxis[0].position)
        yAxis[0].position = config.yAxisConfig.position;
  ...
  var bar_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function calcBarLabelAxisCoordinate(bars) {
      return bars.map(function (bar) {
        ...
        var barLabelAxisPos = tickPosition.map(function (tick, i) {
          ...
          return (
            barItemsStartPos + (barIndex + 0.5) * barWidth + barIndex * barGap
          );
        });
    ...
    function getGradientParams(barItem, i) {
      ...
      if (!barItem.gradient.local) {
        endPos =
          value < 0 ? lineStart[valueAxisIndex] : lineEnd[valueAxisIndex];
      }
  ...
  var pie_1$1 = createCommonjsModule(function (module, exports) {
      ...
      pies.forEach(function (pie) {
        ...
        data.forEach(function (item) {
          ...
          item.percent = parseFloat(
            ((value / sum) * 100).toFixed(percentToFixed)
          );
        });
        var percentSumNoLast = (0, util$1.mulAdd)(
    ...
    function getDataAngle(data, i) {
      ...
      var percentSum = (0, util$1.mulAdd)(
    ...
    function getPieInsideLabelPos(pieItem, dataItem) {
      ...
      return util.getCircleRadianPoint.apply(
        void 0,
    ...
    function calcPiesEdgeCenterPos(pies) {
      pies.forEach(function (pie) {
        ...
        data.forEach(function (item) {
          ...
          var pos = util.getCircleRadianPoint.apply(
            void 0,
    ...
    function addLabelLineAndAlign(dataItem, pieItem) {
      ...
      dataItem.forEach(function (item) {
        ...
        var bendPoint = util.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2["default"])(center).concat([radius, angle])
        );
  ...
  var radarAxis_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function mergeRadarAxisDefaultConfig(radar) {
      return (0,
      util$1.deepMerge)((0, util.deepClone)(config.radarAxisConfig), radar);
    }
    ...
    function getSplitAreaStyle(radarAxis, i) {
      ...
      if (polygon) {
        var point1 = util.getCircleRadianPoint.apply(
          void 0,
        ...
        var point2 = util.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2["default"])(centerPos).concat([
            ringRadius[0],
            axisLineAngles[1]
        ...
        lineWidth = (0, util$1.getPointToLineDistance)(
          centerPos,
          point1,
          point2
        );
  ...
  var radar_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function radar(chart) {
      ...
      var series = option.series;
      if (!series) series = [];
      var radars = (0, util$1.initNeedSeries)(
        series,
        config.radarConfig,
        "radar"
      );
  ...
  var gauge_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function gauge$1(chart) {
      ...
      var series = option.series;
      if (!series) series = [];
      var gauges = (0, util$1.initNeedSeries)(
        series,
        gauge.gaugeConfig,
        "gauge"
      );
      ...
      gauges.forEach(function (gaugeItem) {
        ...
        gaugeItem.tickPosition = new Array(splitNum)
          ...
          .map(function (foo, i) {
            ...
            return [
              util.getCircleRadianPoint.apply(
                void 0,
                (0, _toConsumableArray2["default"])(center).concat([
                  outerRadius,
                  angle
      ...
      gauges.forEach(function (gaugeItem) {
        ...
        var detailsPosition = data.map(function (_ref3) {
          ...
          if (position === "center") {
            ...
            point = util.getCircleRadianPoint.apply(
              void 0,
              (0, _toConsumableArray2["default"])(center).concat([
                radius,
                startAngle
  ...
  var legend_1$1 = createCommonjsModule(function (module, exports) {
    ...
    function legend(chart) {
      ...
      if (legend) {
        legend = (0, util$1.deepMerge)(
          (0, util.deepClone)(config.legendConfig, true),
          legend
        );
      ...
      _c("svg", [
        ...
        _c("rect", {
          attrs: {
            ...
            fill: "transparent",
            "stroke-width": _vm.mergedConfig
              ? _vm.mergedConfig.borderWidth
              : "0",
  ...
  var script$w = {
    ...
    methods: {
      ...
      mergeConfig() {
        let { config, defaultConfig } = this;
        const mergedConfig = util_2$1(
          util_1(defaultConfig, true),
          config || {}
        );
  ...
  var script$y = {
    ...
    methods: {
      ...
      initData() {
        ...
        data = data.map((item) => ({ ...item, percent: item.value / max }));
      ...
      calcSVGPath() {
        ...
        `;
          ...
          return { ...item, d, x: middleXPos, y: middleYPos, textY };
        });
      }
    }
  };
